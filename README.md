...
### MaxPooling
It Calculate the maximum value for each patch of the feature map.
...
<br/> By using Maxpooling we can reduce the number of layers, which inturn reduces number of parameters
